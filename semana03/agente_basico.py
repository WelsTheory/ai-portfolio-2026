...
# -----------------------------------------------------------------------------
# Semana 3 — Agente ReAct con herramientas STM32
# El agente decide qué herramienta usar según la pregunta del usuario.
# Tools disponibles:
#   - calcular_baudrate      → valor BRR para UART
#   - calcular_prescaler     → PSC para timers
#   - consultar_periferico   → info básica de periféricos STM32F407
# -----------------------------------------------------------------------------
...
# En LangChain 1.x create_react_agent está en langgraph.prebuilt
# No necesita prompt manual ni AgentExecutor — el grafo lo maneja internamente
SYSTEM_PROMPT = (
